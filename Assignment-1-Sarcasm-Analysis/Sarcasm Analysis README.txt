...
2. Run the Local Application: Execute the following command on your local machine: java -jar SarcasmAnalysis.jar inputFileName1... inputFileNameN outputFileName1... outputFileNameN n [terminate]
